...
import {
  getOpenSoursesUpdate,
  getOpenSoursesImageCreate,
  getEconomicOpenSourses,
  getOpenSoursesDelete,
...
export const OpenSourses = () => {
  ...
  return (
    (images && images.openSourses && images.openSourses.length > 0 && (
      <div>
        <Modal isOpen={modalOpen} toggle={toggle}>
          <ModalHeader toggle={toggle}>Ochiq muloqot</ModalHeader>
          <ModalBody>
            <Form
              onSubmit={onSubmit}
              initialValues={
        ...
        <table hover className={"fl-table"}>
          ...
          <tbody>
            {images &&
              images.openSourses.length > 0 &&
              images.openSourses.map((el, i) => {
                return (
                  <tr key={el.id}>
                    ...
                    <td className="btn_delete_edit">
                      ...
                      <DeleteBtn
                        handleAdd={() => dispatch(getOpenSoursesDelete(el.id))}
                      />
                    </td>
                  </tr>
                );
