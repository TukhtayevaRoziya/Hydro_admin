...
export const setEconomicHeaderData = (header) => ({
  type: SET_ECONOMIC_HEADER,
  header,
});

// agreement
export const setEconomicImagesData = (images) => ({
  type: SET_ECONOMIC_IMAGES,
  images,
});
export const setEconomicDeleteData = (id) => ({
  type: SET_ECONOMIC_IMAGE_DELETE,
  id,
});
...
// OpenSourses
export const setOpenSoursesImagesData = (openSourses) => ({
  type: SET_OPEN_SOURSES_IMAGES,
  openSourses,
});
export const setOpenSoursesDeleteData = (id) => ({
  type: SET_OPEN_SOURSES_IMAGE_DELETE,
  id,
});
...
export const getEconomicHeader = () => (dispatch) => {
  return economicAPI.setEconomicHeader().then((res) => {
...
export const getEconomicImages = () => (dispatch) => {
  return economicAPI.setEconomic().then((res) => {
...
export const getEconomicDelete = (id) => (dispatch) => {
  return economicAPI.setEconomicDeleteImage(id).then((res) => {
    dispatch(getEconomicImages());
...
export const getChart = () => (dispatch) => {
  return economicAPI.setChart().then((res) => {
...
export const getChartDelete = (id) => (dispatch) => {
  return economicAPI.setChartDelete(id).then((res) => {
    dispatch(getChart());
...
export const getEconomicOpenSourses = () => (dispatch) => {
  return economicAPI.setOpenSourses().then((res) => {
...
export const getOpenSoursesDelete = (id) => (dispatch) => {
  return economicAPI.setOpenSoursesDeleteImage(id).then((res) => {
    dispatch(getEconomicOpenSourses());
    dispatch(setEconomicDeleteData(id));
  });
};
