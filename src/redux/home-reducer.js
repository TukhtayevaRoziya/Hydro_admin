...
const SET_HOME_PROJECT_NUMBERS_IMAGE_DELETE =
  "SET_HOME_PROJECT_NUMBERS_IMAGE_DELETE";
...
export const setHomePanel2Data = (homePanel2) => ({
  type: SET_HOME_PANEL_DATA,
  homePanel2,
});
export const setHomePanel2DeleteData = (id) => ({
  type: SET_HOME_PANEL_DATA_DELETE,
  id,
});

//

export const setHomeCarouselImagesData = (images) => ({
  type: SET_HOME_CAROUSEL_IMAGES,
  images,
});
export const setHomeCarouselImageDeleteData = (id) => ({
  type: SET_HOME_CAROUSEL_IMAGE_DELETE,
  id,
});

export const setHomeAboutImagesData = (images) => ({
  type: SET_HOME_ABOUT_IMAGES,
  images,
});
export const setHomeAboutImageDeleteData = (id) => ({
  type: SET_HOME_ABOUT_IMAGE_DELETE,
  id,
});

export const setHomeOurWorkImagesData = (images) => ({
  type: SET_HOME_OUR_WORK_IMAGES,
  images,
});
export const setHomeOurWorkImageDeleteData = (id) => ({
  type: SET_HOME_OUR_WORK_IMAGE_DELETE,
  id,
});

export const setHomeProjectNumbersImagesData = (images) => ({
  type: SET_HOME_PROJECT_NUMBERS_IMAGES,
  images,
});
export const setHomeProjectNumbersImageDeleteData = (id) => ({
  type: SET_HOME_PROJECT_NUMBERS_IMAGE_DELETE,
  id,
});

export const setHomeRegionImagesData = (images) => ({
  type: SET_HOME_REGION_IMAGES,
  images,
});
export const setHomeRegionImageDeleteData = (id) => ({
  type: SET_HOME_REGION_IMAGE_DELETE,
  id,
});

export const getCarouselImages = () => (dispatch) => {
  return homeApi.setCarousel().then((response) => {
...
export const getCarouselImageDelete = (id) => (dispatch) => {
  return homeApi.setDeleteImage(id).then((response) => {
...
export const getHomePanel2Data = () => (dispatch) => {
  return homeApi.setHomePanel2().then((response) => {
...
export const getHomePanel2Delete = (id) => (dispatch) => {
  return homeApi.setDeleteHomePanel2(id).then((response) => {
...
export const getAboutImages = () => (dispatch) => {
  return homeApi.setAbout().then((response) => {
...
export const getAboutImageDelete = (id) => (dispatch) => {
  return homeApi.setDeleteAbout(id).then((response) => {
...
export const getOurWorkImages = () => (dispatch) => {
  return homeApi.setOurWork().then((response) => {
...
export const getOurWorkImageDelete = (id) => (dispatch) => {
  return homeApi.setDeleteOurWork(id).then((response) => {
...
export const getProjectNumbersImages = () => (dispatch) => {
  return homeApi.setProjectNumbers().then((response) => {
...
export const getProjectNumbersImageDelete = (id) => (dispatch) => {
  return homeApi.setDeleteProjectNumbers(id).then((response) => {
...
export const getRegionImages = () => (dispatch) => {
  return homeApi.setHomePanel8Region().then((response) => {
...
export const getRegionImageDelete = (id) => (dispatch) => {
  return homeApi.setDeleteHomePanel8Region(id).then((response) => {
